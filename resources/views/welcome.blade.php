...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.googleeapis.com/css?family=Amatic+SC" rel = "stylesheet"> -->
        ...
        <style>
            ...
            html{font-family:system-ui,-apple-system,Helvetica Neue,Arial,Noto Sans,sans-serif;line-height:1.5}*,:after,:before{box-sizing:border-box;border:0 solid #e2e8f0}
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                 ...
                 <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h1 class="first-title"> A good idea becomes a great idea when you let it out. </h1> -->
    ...
    <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <body class="background">
            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/newsfeed') }}" class="text-sm text-gray-700 underline">Go to newsfeed</a>
                    @else
                        <a href="{{ route('login') }}"><button class="w3-button w3-theme-d3 w3-padding-40 w3-large w3-margin-top">Login</button></a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"><button class="w3-button w3-theme-d3 w3-padding-40 w3-large w3-margin-top">Register</button></a>
                        @endif
                    @endauth
                </div>
            @endif
